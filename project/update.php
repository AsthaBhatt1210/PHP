<?php
    ...
    if(isset($_POST['btn']))
    {
        ...
        $date=$_POST['idate'];
        $id = $_GET['id'];
        $q= "update foodtb set Item_name='$item_name', Item_Quantity='$item_qty', Item_status='$istatus', Date='$date' where Id=$id";
        $query=mysqli_query($con,$q);
        header('location:index.php');
    } 
	else if(isset($_GET['id'])) 
	{
        $q = "SELECT * FROM foodtb WHERE Id='".$_GET['id']."'";
        $query=mysqli_query($con,$q);
